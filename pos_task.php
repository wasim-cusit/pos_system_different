                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach($sales as $s): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-primary"><i class="bi bi-receipt"></i> Invoice</button>
                                            <button class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach($stock as $st): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-primary"><i class="bi bi-arrow-repeat"></i> Restock</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
